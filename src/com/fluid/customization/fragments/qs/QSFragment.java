...
public class QSFragment extends MainFragment {
    ...
    private void inflateList() {
        ...
        listOfFragments.add(new FrameModel(R.drawable.ic_fluid_qsp, "QS panel", new QSPFragment()));
        listOfFragments.add(new FrameModel(R.drawable.ic_fluid_notifications, "Notifications", new BlankFragment()));
    }
