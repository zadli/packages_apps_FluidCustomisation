package com.fluid.customization.preference;
...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String FLUIDNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, FLUIDNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, FLUIDNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(FLUIDNS, "interval");
            if(newInterval != null)
